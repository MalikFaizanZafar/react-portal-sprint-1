...
type InActiveJobsSubSectionProps = {
  // tabs: new (props: any) => React.Component
};
const InActiveJobsSubSection: FunctionComponent<InActiveJobsSubSectionProps> = ({ children }) => {
...
export default InActiveJobsSubSection;
