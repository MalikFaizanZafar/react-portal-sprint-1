...
import EditSubUser from "./edit-sub-user";
import SubUserDetails from "./sub-user-details";
    ...
    return (
        <div>
                    ...
                    <Table hover className="mt-5 active-job-unprocessed-table">
                        ...
                        <tbody>
                            {existingSubUsers.map((user, i) => {
                                return (
                                    <tr key={i} onClick={() => detailViewHandler(user.id)}>
            ...
            <Row >
                ...
                <Modal className="modal-lg custom-modal" style={{ width: 'width: 90vw' }} isOpen={detailModal} toggle={()=>setDetailModal(!detailModal)} centered >
                    <SubUserDetails />
                </Modal>
            </Row>
            <Row>
